...
<!-- Mirrored from themeearth.com/tf/html/constructpro/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Dec 2017 02:09:56 GMT -->
<head>
	<!-- Meta Tags -->	
	...
	<!-- Title -->
	<title>ConstructPro - Building Company HTML5 Responsive Template</title>		
	<!-- Favicon Icon -->
			...
			<div class="mnmenu-sec">
				<div class="container">
					<div class="row">
						<div class="col-md-3">
							<div class="logo">
								<a href="index-2.html"><img src="img/logo1.png" alt=""/></a>
							</div>
						</div>
						<div class="col-md-9">		
							<div class="menu">
							...
							<div class="media-body">
								<div class="single-post-text">
									...
									<div class="post-info">
										<div class="post-meta">
											<ul>
												<li><span>post by</span><a href="#">Daniel</a></li>
							...
							<div class="media-body">
								<div class="single-post-text">
									...
									<div class="post-info">
										<div class="post-meta">
											<ul>
												<li><span>post by</span><a href="#">Alexander</a></li>
												<li><span>post on</span><a href="#">05 may 17</a></li>
											</ul>									
										</div>																			
									</div>	
							...
							<div class="media-body">
								<div class="single-post-text">
									...
									<div class="post-info">
										<div class="post-meta">
											<ul>
												<li><span>post by</span><a href="#">Gabriel</a></li>
												<li><span>post on</span><a href="#">05 may 17</a></li>
											</ul>									
										</div>																			
									</div>	
					...
					<div class="sidebar">
						...
						<div class="widget-archive">
							...
							<ul>
								...
								<li><a href="#">Construction Management<span>31</span></a></li>
								<li><a href="#">Apartment Design<span>41</span></a></li>
								<li><a href="#">House Planing<span>15</span></a></li>
								<li><a href="#">Architectural Design <span>20</span></a></li>
								<li><a href="#">Interior Design <span>25</span></a></li>
							</ul>
						</div>						
							...
							<div class="all_r_pst">
									...
									<div class="relative-post">								
										...
										<div class="media-body">
											<div class="single_r_dec">
												<h3><a href="blog-details.html">Repair service for your appartment</a></h3>
												<ul>
								...
								<div class="media">										
									<div class="relative-post">								
										...
										<div class="media-body">
											<div class="single_r_dec">
												<h3><a href="blog-details.html">Construction Management</a></h3>
												<ul>
													<li><a href="#"><i class="fa fa-calendar"></i> 05 may 17  </a></li>
													<li><a href="#"><i class="fa fa-calendar"></i>by Admin</a></li>
												</ul>
					...
					<div class="col-md-4 col-sm-6">
						<div class="col-md-6 no-padding">
							<div class="footer-widget-menu">
								...
								<ul>
									...
									<li><a href="#">register and account</a></li>
						...
						<div class="col-md-6 no-padding">
							<div class="bussiness-time">
								<h2> business hour</h2>	
								<span>monday to fridy 10 : 00 am to 07 : 00 pm</span>
								<ul>
									<li>closed</li>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="copy-right">
							<p>&copy; Copyright 2017 <span><a href="#">thethemepond,</a></span> Designed by:<span> crishtopher</span></p>
						</div>
					</div>					
				</div>
			</div>
...
<!-- Mirrored from themeearth.com/tf/html/constructpro/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Dec 2017 02:10:17 GMT -->
</html>